...
<div class="col-xs-6 col-md-offset-3" style="position: relative;top: 10%">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">编辑 《 ${publish.publishName}》 的信息</h3>
        </div>
        <div class="panel-body">
            <%--<form action="publish_edit_do.html?publishId=${publish.publishId}" method="post" id="publishedit" >--%>
            <form action="publish_edit_do.html?" method="post" id="publishedit" >
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="contacter" id="contacter"  value="${publish.contacter}" >
                </div>
                <div class="input-group">
                    <span class="input-group-addon">email</span>
                    <input type="text" class="form-control" name="email" id="email"  value="${publish.email}" >
                </div>
                <div class="input-group">
                ...
                <script>
                    ...
                    $("#readeredit").submit(function () {
                        if($("#publishName").val()==''||$("#phone").val()==''||$("#email").val()==''||$("#address").val()==''){
                            alert("请填入完整的出版社信息！");
