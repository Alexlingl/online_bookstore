...
public class ReaderCardDao {
    ...
    public int getMatchCount(int readerId,String passwd){
        System.out.println(readerId+":"+passwd);
        System.out.println(jdbcTemplate.queryForObject(MATCH_COUNT_SQL,new Object[]{readerId,passwd},Integer.class));
        //构建表中是否有满足条件的元组，并返回匹配的元组数量
    ...
    public ReaderCard findReaderByReaderId(int userId){
        System.out.println("ReaderCardDao.userId="+userId);
    ...
    public int addReaderCard(ReaderInfo readerInfo){
        ...
        System.out.println(readerInfo.getName()+";"+readerInfo.getSex());
